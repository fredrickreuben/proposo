...
import { ILoginFormInput } from '@proposo/interface/form'
...
const LoginDialog = () => {
    ...
    return (
        <Transition appear show={authContext.state.screen == IAuthScreen.LOGIN} as={Fragment}>
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                <Dialog.Title>
                                    ...
                                    <h3 className="text-4xl text-start font-bold mt-2 mb-4">Login</h3>
                                </Dialog.Title>
                                <Dialog.Description>
                                        ...
                                        <form onSubmit={methods.handleSubmit(onSubmit)} autoComplete="off" noValidate>
                                            ...
                                            <div className="modal-action mt-10 mb-10">
                                                <div className="justify-center w-full">
                                                    <Button title="Login" loading={authContext.state.loading} className="btn btn-secondary rounded-full px-14" />
                                                </div>
                                                <div className="justify-end">
                                                    <button type="button" className="btn btn-ghost px-4" onClick={onRegister}>
                                                        Register
                                                    </button>
                                                </div>
                                            </div>
